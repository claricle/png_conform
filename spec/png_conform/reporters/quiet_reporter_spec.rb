...
require "spec_helper"
require "png_conform/reporters/quiet_reporter"

RSpec.describe PngConform::Reporters::QuietReporter do
  ...
  describe "#report" do
    ...
    it "includes file information" do
      ...
      expect(output).to be_empty # QuietReporter only outputs errors
    end
  end
